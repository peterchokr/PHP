...
✅ **완전한 코드**: 9장 + 10장 + 11장 모든 기능 포함
✅ **바로 사용 가능**: 복사해서 그대로 사용 (추가 수정 없음)
✅ **명확한 표시**: 11장에서 새로운 기능을 주석으로 표시
✅ **파일명 구분**: v3_list.php, v3_view.php 등으로 구분

```
9장:  list.php, view.php, add.php, edit.php, delete.php
10장: v2_list.php, v2_view.php, v2_add.php, ...
11장: v3_list.php, v3_view.php, v3_add.php, ...
      v3_download.php, v3_delete_attachment.php
```
...
✅ login.php             (로그인)
✅ logout.php            (로그아웃)
✅ upload_file.php       (파일 업로드 함수)
```

### 게시글 파일

```
✅ v3_list.php           (목록 + 댓글 + 파일 개수 표시)
✅ v3_view.php           (보기 + 댓글 + 파일 표시)
✅ v3_add.php            (작성 + 파일 업로드)
✅ v3_edit.php           (수정 + 파일 관리)
✅ v3_delete.php         (삭제)
```
...
```
✅ v3_add_comment.php       (댓글 작성)
✅ v3_edit_comment.php      (댓글 수정)
✅ v3_delete_comment.php    (댓글 삭제)
```
...
```
✅ v3_download.php           (파일 다운로드)
✅ v3_delete_attachment.php  (파일 삭제)
```

### 디렉토리

```
📁 uploads/files/    (업로드된 파일 저장소)
```
...
2️⃣ uploads/files/ 디렉토리 생성 (chmod 777)
3️⃣ SQL 실행 (posts, comments, attachments 테이블)
4️⃣ login.php 접속
5️⃣ user1 / password123 로그인
6️⃣ v3_list.php로 자동 이동
7️⃣ 게시글 작성 (파일 첨부 가능)
8️⃣ 댓글 추가
9️⃣ 파일 다운로드!
```
...
이제 11장 코드를 바로 사용할 수 있습니다! 🎉
각 파일을 복사해서 v3_*.php로 저장하고 사용하면 됩니다!
